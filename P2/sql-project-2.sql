CREATE DATABASE  IF NOT EXISTS `project2-moviedb` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `project2-moviedb`;
-- MySQL dump 10.13  Distrib 5.6.24, for Win64 (x86_64)
--
-- Host: localhost    Database: project2-moviedb
-- ------------------------------------------------------
...
INSERT INTO `divorced` VALUES (2,'2010-12-14'),(3,'2013-08-26'),(4,'2015-09-30'),(5,'2015-09-28'),(7,'2005-01-01'),(8,'1987-02-28'),(9,'2015-10-02');
...
CREATE TABLE `made_money` (
  ...
  `Category` varchar(20) DEFAULT 'Action',
  PRIMARY KEY (`MOVIE`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `made_money` VALUES ('12 Years a Slave',56667870.00,'2013-11-08','Drama'),('Angels & Demons ',133375846.00,'2009-05-15','Action'),('Bruce Almighty',85734045.00,'2003-05-23','Comedy'),('Catch Me If You Can',60082000.00,'2002-12-25','Comedy'),('Dallas Buyers Club',27296514.00,'2013-11-22','Drama'),('Daredevil',431881.00,'2003-02-14','Action'),('Derailed',22000000.00,'2005-11-11','Action'),('Donnie Brasco',41954997.00,'1997-02-28','Action'),('Fight Club',37023395.00,'1999-10-15','Action'),('Gigli',4753518.00,'2003-08-01','Romantic'),('Gravity',274084951.00,'2013-10-04','Action'),('Harry Potter and the Deathly Hallows: Part 2',380955619.00,'2011-07-15','Action'),('Harry Potter and the Sorcerer\'s Stone',317557891.00,'2001-11-16','Action'),('Ice Age: Continental Drift',161317423.00,'2012-06-13','Comedy'),('Inglourious Basterds',120523073.00,'2009-08-21','Drama'),('Interstellar',187991439.00,'2014-11-07','Action'),('Into the Woods',127997349.00,'2014-12-25','Drama'),('Iron Man 2',312057433.00,'2010-05-07','Action'),('Irreversible',7535012.00,'2002-05-22','Drama'),('Jersey Girl',35000000.00,'2004-03-26','Romantic'),('Lara Croft: Tomb Raider',2355719.00,'2001-06-15','Action'),('Larry Crowne',35565975.00,'2011-07-01','Romantic'),('Lucy',126546825.00,'2014-07-25','Action'),('Maleficent',241407328.00,'2014-05-30','Drama'),('Malena',3429045.00,'2001-02-02','Romantic'),('Mr. & Mrs. Smith',186336103.00,'2005-06-10','Romantic'),('Mr. Success',150001.00,'1984-08-07','Action'),('My Life in Ruins',8662318.00,'2009-06-05','Comedy'),('Ocean\'s Thirteen',117144465.00,'2007-06-08','Action'),('Paper Man',115388.00,'2009-06-15','Drama'),('Pirates of the Caribbean: At World\'s End',309404152.00,'2007-05-25','Comedy'),('The Apartment',8751057.00,'1996-10-02','Romantic'),('The Avengers',623279547.00,'2012-05-04','Action'),('The Bonfire of the Vanities ',15691192.00,'1990-12-21','Comedy'),('The Bourne Ultimatum',227137090.00,'2007-08-03','Action'),('The Captive',225393.00,'2014-12-12','Drama'),('The Company Men',4439063.00,'2011-02-11','Drama'),('The Departed',132373442.00,'2006-10-06','Action'),('The Illusionist',927956.00,'2006-09-01','Romantic'),('The Incredible Hulk',134518390.00,'2008-06-13','Action'),('The Monuments Men',78031620.00,'2014-02-07','Action'),('This Is the End',101470202.00,'2013-06-12','Comedy'),('Volunteers',187569.00,'1985-08-16','Comedy'),('X-Men Origins: Wolverine',179883016.00,'2009-05-01','Action');
...
-- Dump completed on 2015-10-26 17:10:51
